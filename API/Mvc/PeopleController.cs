...
namespace API.Mvc
{
    public class PeopleController : Controller
    {
        ...
        public PeopleController(SkillustratorContext context)
        {
            _context = context;    
        }
        ...
        {
            var skillustratorContext = _context.People.Include(p => p.Organization);
            return View(await skillustratorContext.ToListAsync());
        }
        ...
        {
            ViewData["OrganizationId"] = new SelectList(_context.Set<Organization>(), "Id", "Name");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("FirstName,LastName,OrganizationId,Id")] Person person)
        {
